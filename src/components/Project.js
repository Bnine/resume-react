...
const Project = (props) => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get('/v1/profile/projects', {
        headers: {
            ...
            <Row className={'mb-5'} key={`${index}_handle`}>
              ...
              <Row>
                <Col>
                  ...
                  >
                    <b>
                      {data.projectInfo.company} {data.projectInfo.rank}
                    </b>
                  </p>
                </Col>
              </Row>
              <Row>
                <Col>
                  ...
                  >
                    {data.projectInfo.location} {data.projectInfo.periodStart} ~{' '}
                    {data.projectInfo.periodEnd}
                  </p>
                </Col>
              </Row>
              <hr />
              ...
              {data.details &&
                data.details.map((detailData, index) => (
