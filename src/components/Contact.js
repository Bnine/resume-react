        ...
        <>
            ...
            <Container>
                <Form>
                    ...
                    <Form.Group className="mb-3" controlId="name">
                        ...
                        <Form.Control type="text" placeholder={t('page:inputName')} value={name} onChange={(e) => setName(e.target.value)}/>
                    </Form.Group>
                    <Form.Group className="mb-3" controlId="subject">
                        <Form.Label>{t('page:subject')}</Form.Label>
                        <Form.Control type="text" placeholder={t('page:inputSubject')} value={subject} onChange={(e) => setSubject(e.target.value)}/>
                    </Form.Group>
            ...
            <Container className={'mt-2 mb-3'}>
                <div className={'text-center'}>
                    <Button variant="primary" size="lg" onClick={(e) => checkValidation()}>{t('page:send')}</Button>{' '}
                    <Button variant="secondary" size="lg" onClick={(e) => resetEmail()}>{t('page:reset')}</Button>
                </div>
            </Container>  
        </>
    );
